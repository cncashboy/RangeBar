...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = com.edmodo.rangebar.R.color.general_text_color;
    ...
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = DEFAULT_THUMB_IMAGE_NORMAL;

    // Corresponds to android.R.color.holo_blue_light.
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.GREEN;
